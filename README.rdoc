...
- Movie autocomplete - BROKEN
- Character counter limit on review/summary - BROKEN
...
- remove delete from index and put on profile page
- Spoiler notice (dog tooltip?)
- sorting on homepage/elsewhere
